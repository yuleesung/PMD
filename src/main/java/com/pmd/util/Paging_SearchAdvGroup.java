...
public class Paging_SearchAdvGroup {
	...
	private String searchTypeForAdv;
	private String searchValueForAdv;
	
	public Paging_SearchAdvGroup(int nowPage, int rowTotal, int blockList, int blockPage, String adv_group,
								String searchTypeForAdv, String searchValueForAdv) {
		...
		this.searchTypeForAdv = searchTypeForAdv;
		this.searchValueForAdv = searchValueForAdv;
		...
		if(isPrePage) { // 이전기능 활성
			...
			sb.append(adv_group);
			sb.append("\", \"");
			sb.append(searchTypeForAdv);
			sb.append("\", \"");
			sb.append(searchValueForAdv);
			sb.append("\")'> &lt; </a></li>");
		}else { // 이전기능이 비활성화 상태
	...
	public String getSearchTypeForAdv() {
		return searchTypeForAdv;
	}



	public void setSearchTypeForAdv(String searchTypeForAdv) {
		this.searchTypeForAdv = searchTypeForAdv;
	}



	public String getSearchValueForAdv() {
		return searchValueForAdv;
	}



	public void setSearchValueForAdv(String searchValueForAdv) {
		this.searchValueForAdv = searchValueForAdv;
	}
}
