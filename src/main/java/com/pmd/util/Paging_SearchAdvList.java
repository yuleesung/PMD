...
public class Paging_SearchAdvList {
	...
	private String searchTypeForAdmin;
	private String searchValueForAdmin;
	
	public Paging_SearchAdvList(int nowPage, int rowTotal, int blockList, int blockPage, String b_category,
								String searchTypeForAdmin, String searchValueForAdmin) {
		...
		this.searchTypeForAdmin = searchTypeForAdmin;
		this.searchValueForAdmin = searchValueForAdmin;
		...
		if(isPrePage) { // 이전기능 활성
			...
			sb.append("\", \"");
			sb.append(searchTypeForAdmin);
			sb.append("\", \"");
			sb.append(searchValueForAdmin);
			sb.append("\")'> &lt; </a></li>");
		}else { // 이전기능이 비활성화 상태
	...
	public String getSearchTypeForAdmin() {
		return searchTypeForAdmin;
	}


	public void setSearchTypeForAdmin(String searchTypeForAdmin) {
		this.searchTypeForAdmin = searchTypeForAdmin;
	}



	public String getSearchValueForAdmin() {
		return searchValueForAdmin;
	}



	public void setSearchValueForAdmin(String searchValueForAdmin) {
		this.searchValueForAdmin = searchValueForAdmin;
	}
