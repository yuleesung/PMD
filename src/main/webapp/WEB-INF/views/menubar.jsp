		...
		<div id="header" style="height: 105px;">
			<div id="sign" style="float: right; margin: .2rem .8rem; position: absolute; top: 2px; right: 5px;">
				...
				<c:when test="${userInfo != null}">
					...
					<a href="javascript: logout('${sessionScope.userInfo.sns_type }', '${active }')"title="로그아웃"
						style="color: rgba(255, 255, 255, 0.80); font-size: 13px;">로그아웃</a>
				</c:when>
				<c:otherwise>
					<a href="login.inc?active=${active }" title="로그인" style="color: rgba(255, 255, 255, 0.80); font-size: 13px;">
						로그인
					</a>&nbsp;&nbsp;
					<a href="join.inc?actvie=${active }" title="회원가입" style="color: rgba(255, 255, 255, 0.80); font-size: 13px;">
						회원가입
					</a>
				</c:otherwise>
				</c:choose>
			...
			<div id="menu">
				<ul>
					...
					<li><span style="line-height: 34px; padding: 0;">/</span></li>
